---
title: "Services"
description: "The categories of external services RemoteAgent depends on, and what role each one plays."
---

RemoteAgent is built entirely on managed services — there is no custom infrastructure to provision or maintain.
...
The user interface. RemoteAgent operates as a Telegram bot in webhook mode — Telegram pushes each incoming message to the server rather than the server polling for updates. Every webhook request is verified before processing.
