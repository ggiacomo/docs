...
Your AI runner calls the model API directly from your machine, using credentials stored only on your machine. The RemoteAgent servers relay the prompt you sent via Telegram — they do not process it, interpret it, or log it beyond the preview.
