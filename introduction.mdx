...
The setup takes under five minutes. Install the npm package, run `remoteagentchat init`, open [remoteagent.chat/connect](https://remoteagent.chat/connect) on your phone, enter the pairing code, and you're done.
...
1. You install `remoteagentchat` globally on the machine where your AI agent will run.
