...
<Steps>
  ...
  <Step title="Install your runner (if needed)">
    RemoteAgent supports multiple AI runners. The default is `claude-code` — requires the `claude` CLI installed and authenticated. Other runners require their own binary installed first.
